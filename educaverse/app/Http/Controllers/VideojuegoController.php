...
class VideojuegoController extends Controller
{
    ...
    public function show()
    {
        $videojuegos = Videojuego::join('materias', 'materias.id', '=', 'videojuegos.materia_id')
                        ->select('videojuegos.id', 'videojuegos.nombre', 'videojuegos.descripcion', 'videojuegos.plataformas', 'videojuegos.jugadores', 'videojuegos.categoria_id', 'materias.id as materiaid', 'materias.nombre AS materiaNombre', 'videojuegos.imagen', 'videojuegos.imagen2', 'videojuegos.precio', 'videojuegos.url')
                        ->get();
